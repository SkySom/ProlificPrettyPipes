...
public class FluidItemModel implements IModelGeometry<FluidItemModel> {
    @Override
    public IBakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter,
        ...
        return ItemMultiLayerBakedModel.builder(owner, spriteGetter.apply(new RenderMaterial(
                ...
                new FluidModelItemOverrideList(spriteGetter), PerspectiveMapWrapper.getTransforms(new ModelTransformComposition(
