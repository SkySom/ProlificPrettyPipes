...
import xyz.brassgoggledcoders.prolificprettypipes.pipe.FluidPipeItem;
...
public class ProlificItems {
    ...
    public static final RegistryEntry<BasicExtractionModule<FluidPipeType, FluidStack, IFluidHandler, IFluidModule,
            FluidPipeItem>> FLUID_EXTRACTION_MODULE = ProlificPrettyPipes.getRegistrate()
